...
export default function Skills() {
  ...
  return (
   ...
   <div className="section-header margin-olpo position-relative">
                <h2 className="title ">
                    <span className="shape"><span className='abo'>Skills</span></span> <span>Me</span>
                </h2>
            </div>
  {/* <div className="container">
    <div className="row">
      <div className="col-md-12">
        <h3 className="progress-title">Pace</h3>
        ...
        <h3 className="progress-title">Shooting</h3>
        <div className="progress">
          <div
            className="progress-bar"
            style={{ width: "60%",  }}
        ...
        <h3 className="progress-title">Passing</h3>
        <div className="progress">
          <div
            className="progress-bar"
            style={{ width: "67%",  }}
...
<div className="skill">
   ...
   <section className="award-section padding-bottom padding-top">
  <div className="container">
